...
export const enum CardColor {
  ...
  Spades = 2,
  Clubs = 3,
  None = 4, // გამოიყენება მხოლოდ კოზირის ცხადებისას 9-ანებში
  Null = 5, // ჯოკერს წაღება უნდა (გადაჯოკრა)
}
...
export type JokerSubAction = {
  /**
   * სურს თუ არა ჯოკერს რომ წაიღოს
   * true - სურს
   * false - "ნიჟე"
   */
  want: boolean
  /**
   * თუ პირველი ტარება არის (playerIndex === 0)
   * მაშინ ჯოკერმა აუცილებლად უნდა აცხადოს ფერი
   *
   * სხვა დანარჩენ შემთხვევაში null უნდა დაბრუნდეს
   */
